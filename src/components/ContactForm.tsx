...
export const ContactForm = component$<IGenContactForm>(({ headline }) => {
  return (
    <CenterContainer>
      <form action="#">
        <div class="flex flex-col justify-start items-start max-w-prose relative overflow-hidden gap-8 px-6 py-[15px] rounded-lg bg-white border border-gray-200">
          {headline && (
          ...
          <div class="flex flex-col justify-start items-start self-stretch">
            <div class="flex flex-col justify-start items-start self-stretch flex-grow gap-2.5">
              ...
              <div class="flex justify-start items-center self-stretch flex-grow overflow-hidden rounded-md bg-white border border-gray-200">
                <input
                  type="text"
