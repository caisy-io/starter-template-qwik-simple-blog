    ...
    return (
      <>
        {featuredArticle && (
          <>
            <FullContainer>
              <div class="flex flex-col md:flex-row justify-start items-center self-stretch  relative overflow-hidden gap-[34px] py-[60px]">
                <div class="flex flex-base-1 flex-col w-full md:w-1/2 justify-start items-start flex-grow relative overflow-hidden gap-2.5">
                  {featuredArticle.category?.name && (
                    <div class="flex justify-start items-start ">
                      <div class="flex justify-center items-center relative overflow-hidden gap-2 px-3 py-1.5 rounded-md bg-gray-100">
